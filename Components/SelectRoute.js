...
export default function SelectRoutes({navigation}) {
    ...
    const handleMapRegionChange = function (mapRegion) {
        // mapRegion = {
    ...
    return (
        ...
        <View style={styles.container}>
            {buttonShow ? (
                <Pressable style={styles.SelectRoutebutton} onPress={startRoute}>
